 ...
 */
export interface BaseKeyConfiguration {
    /**
...
export interface HashKeyConfiguration {
    type: 'HASH';
    autoGenerated?: boolean;
}

export interface RangeKeyConfiguration {
    type: 'RANGE';
}

export type KeyConfiguration = HashKeyConfiguration | RangeKeyConfiguration;
 ...
 */
export interface IndexKeyConfiguration extends BaseKeyConfiguration {
    /**
